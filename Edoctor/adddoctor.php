...
<input type="text" name="DoctorName" placeholder="DoctorName" value="" style="width:175px ; color: red;"  /><br><br>
 ...
 <input type="password" name="password" placeholder="password" value="" style="width:175px ; color: red;"   /><br><br>
  <input type="text" name="speciality" placeholder="speciality" value="" style="width:175px ; color: red;"   /><br><br>
 <input type="text" name="Address" placeholder="Address" value="" style="width:175px ; color: red;"   /><br><br>
...
if($rn!="" && $rn1!="" && $sn!="" )
{
$query="INSERT INTO doctor VALUES ('$rn','$rn1','$sn','$an','$bn')";
